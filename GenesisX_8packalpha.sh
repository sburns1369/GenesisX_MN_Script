...
if id "genesisx8" >/dev/null 2>&1; then
echo -e ${YELLOW} "Found user genesisx8!"${CLEAR}
MN8=1
else
...
echo
if [ ! -f /home/genesisx8/.genesisx/genesisx.conf ]; then
if [ ! -f /home/genesisx8/genesisx.conf ]; then
echo -e "${GREEN}Eigth GenesisX Node Configuration Not Found....${CLEAR}"
echo -e "${YELLOW}Configuring Eigth GenesisX Node${CLEAR}"
...
echo "rpcport=19020" >> /home/genesisx8/genesisx.conf
echo "listen=0" >> /home/genesisx8/genesisx.conf
echo "externalip=[${MNIP8}]:5555" >> /home/genesisx8/genesisx.conf
echo "masternodeprivkey=$MNKEY8" >> /home/genesisx8/genesisx.conf
if [[ $NULLREC = "y" ]] ; then
echo "masterNode8 : true" >> /usr/local/nullentrydev/xgs.log
echo "walletVersion8 : 1.4.0" >> /usr/local/nullentrydev/xgs.log
echo "scriptVersion8 : 0.99" >> /usr/local/nullentrydev/xgs.log
fi
else
echo
echo -e ${YELLOW}"Found /home/genesisx8/genesisx.conf"${CLEAR}
echo -e ${YELLOW}"Skipping Pre-stage for Eigth Node "${CLEAR}
MN8=0
fi
else
echo -e ${YELLOW}"Found /home/genesisx8/.genesisx/genesisx.conf"${CLEAR}
