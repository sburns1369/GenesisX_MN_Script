...
echo -e ${GREEN}"Are you sure you want to continue installation of Three GenesisX Masternode?"
...
read privkey3
echo
echo "Creating 3 GenesisX system users with no-login access:"
...
echo "rpcport=$5557" >> /home/genesisx3/.genesisx/genesisx.conf
