...
function_iptables(){
  #Building IP Table
    if [[ customIP = "y" ]] ; then
    echo -e ${GREEN}"IP for Masternode 1 (leave blank if already installed or unused)"${CLEAR}
    read MNIP1
    echo -e ${GREEN}"IP for Masternode 2 (leave blank if already installed or unused)"${CLEAR}
    read MNIP2
    echo -e ${GREEN}"IP for Masternode 3 (leave blank if already installed or unused)"${CLEAR}
    read MNIP3
    echo -e ${GREEN}"IP for Masternode 4 (leave blank if already installed or unused)"${CLEAR}
    read MNIP4
    echo -e ${GREEN}"IP for Masternode 5 (leave blank if already installed or unused)"${CLEAR}
    read MNIP5
    echo -e ${GREEN}"IP for Masternode 6 (leave blank if already installed or unused)"${CLEAR}
    read MNIP6
    echo -e ${GREEN}"IP for Masternode 7 (leave blank if already installed or unused)"${CLEAR}
    read MNIP7
    echo -e ${GREEN}"IP for Masternode 8 (leave blank if already installed or unused)"${CLEAR}
    read MNIP8
    echo -e ${GREEN}"IP for Masternode 9 (leave blank if already installed or unused)"${CLEAR}
    read MNIP9
    echo -e ${GREEN}"IP for Masternode 10 (leave blank if already installed or unused)"${CLEAR}
    read MNIP9
    else
...
function_masternode_upgrade(){
  ...
  function_read_masternode_upgrade(){
    local choice
  	read -p "Enter choice " choice
    case $choice in
      1)bash <(curl -Ls https://raw.githubusercontent.com/sburns1369/GenesisX_MN_Script/master/GenesisX_singleV4.sh);;
